...
Adoptify — вебзастосунок підтримки прийняття рішень для адаптації тварин в умовах кризових ситуацій. Проєкт реалізує дипломну тему: каталог тварин, AHP-анкету, пояснюваний підбір, заявки на адаптацію, волонтерський кабінет, кабінет притулку, адміністративну верифікацію та PWA-режим.
